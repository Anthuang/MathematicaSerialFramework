...
(* ::Text:: *)
(*This package is an example usage of our Serial Framework package to display data obtained from robots. We implemented data visualization for data from the IMU and commands sent to the servos. This package must be complemented by the mbed files or else it may not function properly.*)
(**)
